...
class DooLinks{
    ...
    public static function types(){
        return array( __d('Download'), __d('SEASON 01'), __d('SEASON 02'), __d('SEASON 03'), __d('SEASON 04'), __d('SEASON 05'), __d('SEASON 06'), __d('SEASON 07'), __d('SEASON 08'), __d('SEASON 09'), __d('SEASON 10'));
    }
...
/**
    ...
    public function admin_form_editor_ajax(){
	    ...
	    $out .= '</select></span>';
            $out .= '<span><select id="doolinkeditor_odio">';
            // Get item not defined
            if(!in_array($odi, $this->odios())){
